...
(function() {
    ...
    function J(a, b, c) {
        var d, e;
        if (Ca(b)) q(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b));
        else if (q(b) && fa(b))
    ...
    var r, B = document,
        ...
        Db = M.opera,
        xa = /(msie|trident)/i.test(za) && !Db,
        bb = B.documentMode === 8,
        cb = /AppleWebKit/.test(za),
        Ia = /Firefox/.test(za),
        Eb = /(Mobile|Android|Windows Phone)/.test(za),
        Aa = "http://www.w3.org/2000/svg",
        da = !!B.createElementNS && !!B.createElementNS(Aa, "svg").createSVGRect,
        Jb = Ia && parseInt(za.split("Firefox/")[1], 10) < 4,
        ha = !da && !xa && !!B.createElement("canvas").getContext,
        Oa, Sa, Fb = {},
        nb = 0,
        ab, K, La, ia, ob, db, U = function() {
            return r
        },
        X = [],
        Ta = 0,
        ...
        Lb = "stroke-width",
        Ha, ub, jb, vb, wb, xb, yb, kb, lb, zb, Ab, A = {},
        C;
    ...
    C.numberFormat = function(a, b, c, d) {
        var e = K.lang,
            a = +a || 0,
            f = b === -1 ? H((a.toString().split(".")[1] || "").length, 20) : isNaN(b = S(b)) ? 2 : b,
            b = c === void 0 ? e.decimalPoint : c,
            d = d === void 0 ? e.thousandsSep : d,
            e = a < 0 ? "-" : "",
            c = String(D(a = S(a).toFixed(f))),
    ...
    R.prototype = {
        ...
        applyTextShadow: function(a) {
            var b = this.element,
                ...
                e = {},
                f = this.renderer.forExport || b.style.textShadow !== r && !xa;
        ...
        show: function(a) {
            a && this.element.namespaceURI ===
                Aa ? this.element.removeAttribute("visibility") : this.attr({
            ...
            !f && !p && !y && e.indexOf(" ") === -1 ? b.appendChild(B.createTextNode(t(e))) : (h = /<.*style="([^"]+)".*>/,
                i = /<.*href="(http[^"]+)".*>/, v && v.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), l(e, function(e, f) {
                    ...
                    l(g, function(e) {
                        if (e !== "" || g.length === 1) {
                            var p = {},
                                l = B.createElementNS(Aa, "tspan"),
                                z;
                            h.test(e) && (z = e.match(h)[1].replace(/(;| |^)color([ :])/,
                                "$1fill$2"), J(l, "style", z));
                            i.test(e) && !d && (J(l, "onclick", 'location.href="' + e.match(i)[1] + '"'), F(l, {
                                cursor: "pointer"
                            }));
                            e = t(e.replace(/<(.|\n)*?>/g, "") || " ");
                            if (e !== " ") {
                                ...
                                if (m) {
                                    for (var p = e.replace(/([^\^])-/g, "$1- ").split(" "), o = g.length > 1 || f || p.length > 1 && k.whiteSpace !== "nowrap", v, G, r, s = [], q = N(l), u = 1, x = a.rotation, w = e, A = w.length;
                                        (o || y) && (p.length ||
    ...
    s(R.prototype, {
        ...
        setSpanRotation: function(a, b, c) {
            var d = {},
                e = xa ? "-ms-transform" : cb ? "-webkit-transform" : Ia ? "MozTransform" : Db ? "-o-transform" : "";
    ...
    if (!da && !ha) E = {
        ...
        init: function(a, b, c, d) {
            var e;
            this.alignedObjects = [];
            d = this.createElement(Ga).css(s(this.getStyle(d), {
                position: "relative"
            }));
            e = d.element;
        ...
        color: function(a, b, c, d) {
            ...
            if (i) {
                ...
                if (c === "fill")
                    if (i === "gradient") c = n.x1 || n[0] || 0, a = n.y1 || n[1] || 0, p = n.x2 || n[2] || 0, n = n.y2 || n[3] || 0, t = 'angle="' + (90 - L.atan((n - a) / (p - c)) * 180 / mb) + '"', r();
                    else {
                        var j = n.r,
                            s = j * 2,
                            u = j * 2,
            ...
            } else if (g.test(a) && b.tagName !== "IMG") f = W(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], aa(this.prepVML(h), null, null, b), j = f.get("rgb");
            else {
    ...
    Na.prototype = {
        addLabel: function() {
            ...
            b = a.labelFormatter.call({
                ...
                value: a.isLog ? ya(oa(e)) : e
            });
            q(d) ? d && d.attr({
                text: b
            }) : (this.labelLength = (this.label = d = q(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(w(g.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0)
        },
        ...
        handleOverflow: function(a) {
            var b = this.axis,
                ...
                e = b.chart.spacing,
                f = o(b.labelLeft, H(b.pos, e[3])),
                e = o(b.labelRight, u(b.pos +
                    b.len, d - e[1])),
                g = this.label,
                h = this.rotation,
                i = {
                ...
                m = 1,
                n, p = {};
            if (h) h < 0 && c - i * j < f ? n = x(c / la(h * ma) - f) : h > 0 && c + i * j > e && (n = x((d - c) / la(h * ma)));
            else if (d = c + (1 - i) * j, c - i * j < f ? k = a.x + k * (1 - i) - f : d > e && (k = e - a.x + k * i, m = -1), k = H(b.slotWidth, k), k < b.slotWidth && b.labelAlign === "center" && (a.x += m * (b.slotWidth - k - i * (b.slotWidth - H(j, k)))), j > k || b.autoRotation && g.styles.width) n = k;
            if (n) {
                p.width = n;
        ...
        render: function(a, b, c) {
            var d = this.axis,
                ...
                s = !0,
                u = d.tickmarkOffset,
                q = this.getPosition(g, j, u, b),
                x = q.x,
                q = q.y,
                w = g && x === d.pos + d.len || !g && q === d.pos ? -1 : 1,
                c = o(c, 1);
            this.isActive = !0;
            if (y) {
    ...
    Y.prototype = {
        ...
        defaultLabelFormatter: function() {
            ...
            if (h) g = Ka(h, this);
                ...
                for (; f-- && g === r;) c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !== null && (g = C.numberFormat(b / c, -1) + e[f]);
        ...
        setAxisTranslation: function(a) {
            var b = this,
                ...
                k = b.isXAxis;
            if (k || i || d)
                if (h ? (f = h.minPointOffset, g = h.pointRangePadding) : l(b.series, function(a) {
        ...
        getTickAmount: function() {
            ...
            !q(c.tickInterval) && this.len < e && !this.isRadial &&
                !this.isLog && c.startOnTick && c.endOnTick && (d = 2);
        ...
        getExtremes: function() {
            var a = this.isLog;
            return {
                min: a ? ya(oa(this.min)) : this.min,
                max: a ? ya(oa(this.max)) : this.max,
        ...
        getOffset: function() {
            ...
            if (j || a.isLinked) {
                ...
                for (G in f) f[G].destroy(), delete f[G];
        ...
        getLinePath: function(a) {
            ...
            return b.renderer.crispLine(["M", e ? this.left : f, e ? d : this.top, "L", e ? b.chartWidth -
                this.right : f, e ? d : b.chartHeight - this.bottom
            ], a)
        },
        ...
        render: function() {
            var a = this,
                ...
                p = a.tickmarkOffset,
                o = d.lineWidth,
                z, v = b.hasRendered && q(a.oldMin) && !isNaN(a.oldMin),
                N = a.showAxis,
                t, G;
            ...
            if (o) z = a.getLinePath(o), a.axisLine ? a.axisLine.animate({
                d: z
            }) : a.axisLine = c.path(z).attr({
                stroke: d.lineColor,
                "stroke-width": o,
                zIndex: 7
        ...
        drawCrosshair: function(a, b) {
            var c, d = this.crosshair,
                e = d.animation;
            if (!this.crosshair || (q(b) || !o(this.crosshair.snap, !0)) === !1 || b && b.series && b.series[this.coll] !== this) this.hideCrosshair();
            else if (o(d.snap, !0) ? q(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : o(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null,
    ...
    Y.prototype.getLogTickPositions = function(a,
        ...
        if (a >= 0.5) a = x(a), g = this.getLinearTickPositions(a, b, c);
            ...
            for (var f = ga(b), h, i, j, k, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
                i = e.length;
    ...
    Hb.prototype = {
        ...
        getPosition: function(a, b, c) {
            var d = this.chart,
                ...
                k = o(c.ttBelow, d.inverted && !c.negative || !d.inverted &&
                    c.negative),
                m = function(a, b, c, d) {
                    var h = c < d - e,
                        i = d + e + c < b,
    ...
    Ba.prototype = {
        ...
        runPointActions: function(a) {
            ...
            if (!e && !g)
                ...
                k = !e && b.directTouch;
                b.visible && !j && !k && o(b.options.enableMouseTracking, !0) && (p = b.searchPoint(a, !j && b.kdDimensions === 1)) && m.push(p)
            }), l(m, function(a) {
        ...
        drag: function(a) {
            ...
            if (this.hasDragged > 10) {
                ...
                this.selectionMarker &&
                    g && (d = e - p, this.selectionMarker.attr({
                        height: S(d),
                        y: (d > 0 ? 0 : d) + p
                    }));
        ...
        onContainerClick: function(a) {
            var b = this.chart,
                ...
                a = this.normalize(a);
            a.originalEvent = a;
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (O(c.series, "click", s(a, {
                point: c
            })), b.hoverPoint && c.firePointEvent("click", a)) : (s(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && O(b, "click", a)))
        },
    ...
    Xa.prototype = {
        ...
        adjustMargins: function(a, b) {
            ...
            this.display &&
                !d.floating && l([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function(f, g) {
    ...
    na.prototype = {
        ...
        drawChartBox: function() {
            ...
            if (k) f ? f.animate(t) : this.plotBackground = b.rect(l, o, v, q, 0).attr({
                fill: k
    ...
    $.prototype = {
        ...
        tooltipFormatter: function(a) {
            var b = this.series,
                ...
                e = c.valuePrefix || "",
                f = c.valueSuffix || "";
            l(b.pointArrayMap || ["y"], function(b) {
                b = "{point." + b;
    ...
    T.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) l(a, function(a, b) {
                ...
                if (p && h > p) {
                    ...
                    if (ra(k)) {
                        ...
                        if (v)
                            for (c = 0; c < h; c++) i = a[c], y[c] = i[0], z[c] = i.slice(1, v + 1);
                        else
                            for (c = 0; c < h; c++) i = a[c], y[c] = i[0], z[c] = i[1];
                    else ca(12)
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== r && (i = {
                                series: e
                            }, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c), n && i.name)) m.names[i.x] = i.name;
                Ca(z[0]) && ca(14, !0);
                e.data = [];
                e.options.data = a;
                for (c = g; c--;) f[c] &&
        ...
        processData: function(a) {
            ...
            if (k && this.sorted && (!i || d > i || this.forceCrop))
                ...
                else if (b[0] < m || b[d - 1] > n) e = this.cropData(this.xData,
        ...
        generatePoints: function() {
            ...
            if (b && (g !== (c = b.length) || j))
                for (n = 0; n < c; n++)
                    if (n === h && !j && (n += g), b[n]) b[n].destroyElements(), b[n].plotX =
                        r;
            this.data = b;
            this.points = m
        },
        getExtremes: function(a) {
            ...
            d = a.length;
            for (m = 0; m < d; m++)
                if (j = c[m], k = a[m], i = k !== null && k !== r && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[m + 1] || j) >= g && (c[m - 1] || j) <= h, i && j)
                    if (i = k.length)
        ...
        drawPoints: function() {
            var a, b = this.points,
                ...
                n = this.pointAttr[""],
                p, l, z, v = this.markerGroup,
                q = o(m.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * m.radius);
            if (m.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = ga(g.plotX), e = g.plotY, k = g.graphic, p = g.marker || {}, l = !!g.marker, a = q && p.enabled === r || p.enabled, z = g.isInside, a && e !== r && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || n, h = a.r, i = o(p.symbol, this.symbol), j = i.indexOf("url") ===
                            0, k) k[z ? "show" : "hide"](!0).animate(s({
                            x: d - h,
                            y: e - h
                        }, k.symbolName ? {
                            width: 2 * h,
            ...
            function e() {
                ...
                if (fa(a) && !Da(a)) f.redraw = function() {
                    if (h)
                        ...
                        else h.attr(f.pointAttr[f.state ||
    ...
    s(Y.prototype, {
        update: function(a, b) {
            var c = this.chart,
                a = c.options[this.coll][this.options.index] = w(this.userOptions,
                    a);
            this.destroy(!0);
    ...
    E = ba(T, {
        ...
        getColumnMetrics: function() {
            ...
            var c = H(S(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len),
                j = c * b.groupPadding,
                k = (c - 2 * j) / i,
                m = b.pointWidth,
                b = q(m) ? (k - m) / 2 : k * b.pointPadding,
                m = o(m, k - 2 * b);
        ...
        drawPoints: function() {
            ...
            l(a.points, function(h) {
                var i = h.plotY,
                    j = h.graphic;
                if (i !== r && !isNaN(i) && h.y !== null) f = h.shapeArgs, i = q(a.borderWidth) ? {
                    "stroke-width": a.borderWidth
                } : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ? (Va(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](w(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
    ...
    T.prototype.drawDataLabels = function() {
        ...
        if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" :
            "visible", d.zIndex || 6), o(d.defer, !0) && (j.attr({
            opacity: +h
        }), h || P(a, "afterAnimate", function() {
            a.visible && j.show();
    ...
    T.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (m) d = s({
            ...
            align: c.align
        })) : (b.align(c, null, d), g = b.alignAttr, o(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) : o(c.crop, !0) && (m = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)), c.shape && b.attr({
            anchorX: a.plotX,
            anchorY: a.plotY
        }));
        if (!m) b.attr({
    ...
    if (A.pie) A.pie.prototype.drawDataLabels = function() {
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
                    ...
                    if (n > 0) {
                        ...
                        for (I = 0; I < M; I++) {
                            ...
                            if (J < I && L[I] !== null) J = I;
                                ...
                                for (t < M - I + J && L[I] !== null && (J = t - M + I); L[J] === null;) J++;
                            P.push({
                                i: J,
                                y: L[J]
                            });
            ...
            if (Fa(F) === 0 || this.verifyDataLabelOverflow(F)) this.placeDataLabels(), v && g && l(this.points, function(b) {
                j = b.connector;
                w = b.labelPos;
                if ((s = b.dataLabel) && s._pos && b.visible) D = s._attr.visibility, C = s.connX, B = s.connY, k = m ? ["M", C + (w[6] === "left" ? 5 : -5), B, "C", C, B, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", C + (w[6] === "left" ? 5 : -5), B, "L", w[2], w[3], "L", w[4], w[5]], j ? (j.animate({
                    d: k
    ...
    (function(a) {
        ...
        b.prototype.hideOverlappingLabels = function(a) {
            ...
            for (d = 0; d < b; d++) {
                e = a[d];
                for (c = d + 1; c < b; ++c)
                    if (k = a[c], e && k && e.placed && k.placed && e.newOpacity !== 0 && k.newOpacity !== 0 && !(k.alignAttr.x > e.alignAttr.x +
    ...
    var Ib = ba($, {
        ...
        onMouseOver: function(a) {
            ...
            if (this.value !==
                null) $.prototype.onMouseOver.call(this, a);
    ...
    (function(a) {
        ...
        b.prototype.hideOverlappingLabels = function(a) {
            ...
            for (d = 0; d < b; d++) {
                e = a[d];
                for (c = d + 1; c < b; ++c)
                    if (k = a[c], e && k && e.placed && k.placed &&
    ...
    s(na.prototype, {
        renderMapNavigation: function() {
            ...
            if (o(b.enableButtons, b.enabled) && !a.renderer.forExport)
                for (d in c)
                    if (c.hasOwnProperty(d)) f = w(b.buttonOptions, c[d]), e = f.theme, e.style = w(f.theme.style, f.style), g = e.states, e = a.renderer.button(f.text, 0, 0, h, e, g && g.hover, g && g.select, 0, d === "zoomIn" ? "topbutton" : "bottombutton").attr({
                        width: f.width,
                        height: f.height,
    ...
    ea(na.prototype, "render", function(a) {
        ...
        o(c.enableMouseWheelZoom, c.enabled) && P(b.container, document.onmousewheel ===
            void 0 ? "DOMMouseScroll" : "mousewheel",
            function(a) {
    ...
    Y.prototype.beforePadding = function() {
        var a = this,
            ...
            h = this.min,
            i = {},
            j = L.min(c.plotWidth, c.plotHeight),
            k = Number.MAX_VALUE,
            m = -Number.MAX_VALUE,
            n = this.max - h,
        ...
        l(this.series, function(b) {
            ...
            if (b.bubblePadding && (b.visible || !c.options.chart.ignoreHiddenSeries))
                if (a.allowZoomOutside = !0, q.push(b), f) l(["minSize", "maxSize"], function(a) {
                    var b = d[a],
                        c = /%$/.test(b),
                        b = D(b);
                    i[a] = c ? j * b / 100 : b
    ...
    na.prototype.transformFromLatLon = function(a, b) {
        if (window.proj4 === void 0) return ca(21), {
            x: 0,
            y: null
        };
    ...
    C.geojson = function(a, b, c) {
        ...
        l(a.features, function(a) {
            ...
            b === "map" || b === "mapbubble" ? (i === "Polygon" ? (l(c, f), e.push("Z")) : i === "MultiPolygon" && (l(c, function(a) {
                ...
                path: e
            })) : b === "mapline" ? (i === "LineString" ? f(c) : i === "MultiLineString" && l(c,
                f), e.length && (j = {
                path: e
        ...
        pan: function(a, b) {
            ...
            l(b === "xy" ? [1, 0] : [1], function(b) {
                var d = a[b ? "chartX" : "chartY"],
                    ...
                    i = i > d;
                if (h.series.length && (i || l > H(k.dataMin, k.min)) && (!i || j < u(k.dataMax, k.max))) h.setExtremes(l, j, !1, !1, {
                    trigger: "pan"
                }), e = !0;
